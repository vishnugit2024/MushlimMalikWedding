  ...
  const reasons = [
    {
      ...
      description: "Access a database of 100% verified and trustworthy profiles to make your search safe and effective.",
    },
    {
      icon: "bi bi-lightning-charge",
      title: "Priority Support",
      description: "Enjoy faster response times and dedicated support for a seamless experience.",
    },
    {
      icon: "bi bi-heart",
      title: "Matchmaking Made Easy",
      description: "Discover profiles that match your preferences and connect with potential partners effortlessly.",
    },
    {
      icon: "bi bi-shield-lock",
      title: "Secure and Private",
      description: "We prioritize your privacy with top-notch security and safety features.",
    },
  ];
    ...
    <>
      ...
      <div className="container">
        ...
        <p className="text-center mb-5">
          Unlock premium features and experience seamless matchmaking with our expertly curated membership plans.
        </p>
        <div className="row">
